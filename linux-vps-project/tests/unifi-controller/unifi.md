...
hi i have https://hub.docker.com/r/linuxserver/unifi-controller from this site, but i dont know if i am doing it right, right now i am stucked where i combined the database and the unifi-network application. it says wrong passowrd, and does not want to connect. so i am thinking that it was a bad idea and i want you to let me see what the RIGHT way to do it is. 


also, iam not doing it here, i am doing it on my unifi server, so this is windows, i just want you to think and put me some .md file with the right way to do it. do not execute anything!
